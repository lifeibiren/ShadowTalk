...
public:
    ...
    typedef boost::signals2::signal<void(boost::shared_ptr<message> msg)>
        message_signal;
    typedef message_signal::slot_type message_signal_handler;
    typedef std::set<boost::shared_ptr<peer>,
        peer_comp<boost::shared_ptr<peer>>>
        live_peers_set_type;
...
private:
    ...
    typedef boost::bimap<boost::bimaps::set_of<boost::asio::ip::udp::endpoint>,
        boost::bimaps::set_of<boost::shared_ptr<peer>,
            peer_comp<boost::shared_ptr<peer>>>>
        peer_endpoint_bm_type;
    peer_endpoint_bm_type peer_endpoint_bm_;

    typedef std::map<boost::shared_ptr<std::string>, boost::shared_ptr<message>>
        to_be_sent_map_type;
