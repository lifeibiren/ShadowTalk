...
add_trusted_peer_public_key::add_trusted_peer_public_key(
...
stream_message::stream_message(
    msg_type type, address addr, datagram::id_type id)
    : message(type)
    , addr_(addr)
    , id_(id) {}
...
data_message::data_message(
    msg_type type, address addr, datagram::id_type id, const std::string &data)
    : message(type)
    , addr_(addr)
    , id_(id)
    , data_(data) {}
...
recv_data::recv_data(
    address addr, datagram::id_type id, const std::string &data)
