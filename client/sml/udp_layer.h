...
public:
    ...
    udp_layer(asio::io_context &io_context, uint16_t port);
...
private:
    ...
    void handle_send(const boost::system::error_code& error_message, shared_ptr<std::string> message, shared_ptr<address> addr,
