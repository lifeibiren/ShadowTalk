...
void udp_service::send_to(boost::shared_ptr<std::string> message, const boost::asio::ip::udp::endpoint &endpoint)
{
    socket_.async_send_to(boost::asio::buffer(*message), endpoint,
                          boost::bind(&udp_service::handle_send, this, message,
...
void udp_service::handle_receive(const boost::system::error_code& error,
